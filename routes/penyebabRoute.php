    ...
    case 'penyebab':
        ...
        if ($method === 'GET') {
            if ($method === 'GET' && $action === 'pdf') {
                ...
                require __DIR__ . '/../templates/penyebabPdf.php';
            ...
            if (is_numeric($action)) {
                $result = $penyebab->getById($action);
        ...
        if ($method === 'PUT') {
            ...
            $result = $penyebab->update($action, $input);
